...
function agregarHeladoFavorito(listaDePersonas, listaDeHelados) {
    return listaDePersonas.map((p, i) => ({
        ...p,
        heladoFavorito: i < listaDeHelados.length ? listaDeHelados[i] : "vainilla"
    }));
}

console.log(
    "agregarHeladoFavorito()",
    agregarHeladoFavorito(listaPersonasEjemplo, ["chocolate", "limón", "frutilla"])
);
